...
@objc public class GoogleInteractiveMediaAdsAdapter: NSObject, ZPPlayerDependantPluginProtocol {
    weak public var playerPlugin: (QBPlayerProtocol & ZPDependablePlayerPluginProtocol)?
